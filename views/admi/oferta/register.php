...
<div class="contenedor-registro-informacion 
  ...
  <form action="?controller=oferta&&action=save" method="POST" class="registro-informacion__formulario" >
    <div class="formulario__encabezado">
      <h1 class="titulo"> Registro Oferta de Empleo </h1>
    </div>
    ...
    <div class="formulario__campo-grupos formulario__campo-grupos-iconos">
      <input type="text" name="vacantes" placeholder="Vacantes" required="">
      <span class="input-icon">
        <i class="fas fa-chalkboard-teacher"></i>
      </span>
    </div>
    ...
    <div class="formulario__campo-grupos formulario__campo-grupos-iconos">
      <input type="text-area" name="descripcion" placeholder="Descripcion de la Oferta Laboral" required="">
      <span class="input-icon">
