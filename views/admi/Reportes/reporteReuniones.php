<?php 
	 ...
	 $hastafecha     =  $_POST['hastafecha'];
	 		 ...
	 		 $consulta = "SELECT id, fecha,descripcion, lugar, hora
	 				 FROM reunion 
	 					WHERE fecha  
	...
	$pdf->SetY(25);
	$pdf->text(46,40,'REPORTE DE REUNIONES PUBLICADAS',0,0,'C');
